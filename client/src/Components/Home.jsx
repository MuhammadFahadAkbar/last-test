...
const Home = () => {
  return (
    <div className="max-w-[95%] mx-auto my-10 md:max-w-screen-xl md:my-20">
      <h4 className="mb-3 font-semibold text-center text-xl md:text-3xl md:mb-10 lg:text-4xl text-red-900">
      ...
      <div className="flex justify-center">
        <button className="px-5 py-3 mr-3 bg-red-900 text-white md:py-3 md:px-20 md:text-lg md:mr-5">
