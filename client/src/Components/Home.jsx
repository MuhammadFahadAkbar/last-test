...
const Home = () => {
  return (
    <div className="max-w-[95%] mx-auto my-10 md:max-w-screen-xl md:my-20">
      <h4 className="mb-3 font-semibold text-center text-xl md:text-3xl md:mb-10 lg:text-4xl text-red-500">
      ...
      <div className="flex justify-center">
        <button className="px-5 py-3 mr-3 bg-red-950 text-white md:py-3 md:px-20 md:text-lg md:mr-5">
          <Link to={`/form`}>FILL OUT OUR FORM</Link>
        </button>
        <button className="px-5 py-3 ml-3 bg-red-950 text-white md:py-3 md:px-20 md:text-lg md:ml-5">
